...
def fit_EM(m1, m2, filename, data, image):
    ...
    io_data.write_data(back_data,"./output/"+str(filename)+"_back.txt")
    io_data.read_data("./output/"+str(filename)+"_back.txt", False, save=True, save_name="./output/"+str(filename)+"_background.jpg")


    io_data.write_data(front_data,"./output/"+str(filename)+"_fore.txt")
    io_data.read_data("./output/"+str(filename)+"_fore.txt", False, save=True, save_name="./output/"+str(filename)+"_foreground.jpg")


    io_data.write_data(mask_data,"./output/"+str(filename)+"_mask.txt")
    io_data.read_data("./output/"+str(filename)+"_mask.txt", False, save=True, save_name="./output/"+str(filename)+"_masked.jpg")
...
def main():
    ...
    data, image = io_data.read_data("./a2/cow.txt", True)
